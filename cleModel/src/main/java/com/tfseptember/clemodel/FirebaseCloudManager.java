            ...
            while (true) {
                FirebaseRemoteConfig.getInstance().fetchAndActivate().addOnCompleteListener(task -> {
                    if (!isFetchSuccessful && task.isSuccessful()) {
                        ...
                        try {
                            String notify_sleep_time = getString(BlueTenChangeUtils.INSTANCE.getCoolTimeStar(), "");
                            ...
                            if (!TextUtils.isEmpty(notify_sleep_time)) {
                                ...
                                BlueTenSPUtils.putLong(BlueTenChangeUtils.INSTANCE.getCoolTimeStar(), sleep_time);
                            }
