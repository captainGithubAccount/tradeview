...
object DownloadChangeUtils {
    ...
    val procressList = listOf(
        ...
        "Close background apps to boost download.",
    ...
    // todo 修改内容
    // 通知点击
    var noti_click_str = "downloadaoos"

    var coolTimeStar = "download_notify_sleep_time"

    // 启动页路径
    var launchActivityPath = "com.xvplayer.xvdownloader.MainActivity"
