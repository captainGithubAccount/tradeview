...
import com.download.model.old.opdj.nt.DownloadNtFgHelper;
...
public class DownloadNotificationHelper {
    private static final String TAG = "DownloadNotificationHelper";
    ...
    private static DownloadNotificationHelper instance;
    
    private DownloadNotificationHelper(Context context) {
        this.context = context.getApplicationContext();
    }
    
    public static synchronized DownloadNotificationHelper getInstance(Context context) {
        if (instance == null) {
            instance = new DownloadNotificationHelper(context);
        }
        return instance;
    }
