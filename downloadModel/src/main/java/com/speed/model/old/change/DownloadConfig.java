...
public class DownloadConfig {
    public static void configLaunchClickStr(String str){
        DownloadChangeUtils.INSTANCE.setNoti_click_str(str);
    }

    public static void configLaunchPath(String path){
        DownloadChangeUtils.INSTANCE.setLaunchActivityPath(path);
    }

    public static void configHeartUrl(String url){
        DownloadChangeUtils.INSTANCE.setHttpHeartUrl(url);
    }

    public static void configFcmUrl(String url){
        DownloadChangeUtils.INSTANCE.setFCM_URL(url);
    }

    public static void configFcmInterfacePath(String path){
        DownloadChangeUtils.INSTANCE.setFCM_INTERFACE_PATH(path);
    }
}
