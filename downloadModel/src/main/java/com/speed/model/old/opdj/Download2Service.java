...
public class Download2Service extends Service {
    ...
    private boolean mIsBound = false; // 绑定状态标志
    ...
    private void doBindMainService() {
        ...
        try {
            mIsBound = this.bindService(new Intent(this, Download1Service.class), this.mRemoteServiceConn, 1);
...
// 4. 【核心修复】在服务销毁时确保解绑
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        Log.d(TAG, "Download2Service 销毁，开始清理连接");
        isLiving = false;
        // 务必在此处检查并解绑
    ...
    class ServiceBinder extends IProcessServiceDownload.Stub {
        ServiceBinder(Download2Service this$0) {
    ...
    class RemoteServiceConnection implements ServiceConnection {
        RemoteServiceConnection(Download2Service this$0) {
        }

        public void onServiceConnected(ComponentName name, IBinder service) {
            Download2Service.mainBinder = service;
            try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            Download2Service.mainBinder = null;
            Download2Service.isReTryBinding = true;
