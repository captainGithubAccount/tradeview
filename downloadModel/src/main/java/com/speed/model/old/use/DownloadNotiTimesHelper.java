 ...
 * 所有方法都是静态的，无需创建对象
 */
public class DownloadNotiTimesHelper {
    ...
    public static void updateConfig() {
        int highCount = (int) FirebaseRemoteConfig.getInstance().getLong(DownloadLocalInit.highCount);
        int highCoolTime = (int) FirebaseRemoteConfig.getInstance().getLong(DownloadLocalInit.highCoolTime);
        int lowCoolTime = (int) FirebaseRemoteConfig.getInstance().getLong(DownloadLocalInit.lowCoolTime);
