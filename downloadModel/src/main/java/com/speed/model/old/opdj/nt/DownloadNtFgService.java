...
public class DownloadNtFgService extends Service {
    ...
    public static void startNotifyService(boolean isFromActivity, String from) {
        try {
            ...
            Intent intent = new Intent(context, DownloadNtFgService.class);
            intent.putExtra(DownloadNtFgService.from, from);
...
//                this.startForeground(Notification_ID1, createOngoingNotification(CHANNEL_NAME1), ServiceInfo.FOREGROUND_SERVICE_TYPE_DATA_SYNC);
        ...
        if(intent != null){
            ...
            if(Objects.equals(from_action, "clock")){
                ...
                DownloadNtTransfer.onTimeTickUpEvent(DownloadNotiTimesHelper.Event.JOB_POLLING );
            }else if(Objects.equals(from_action, "everytime_show_notify")){
                DownloadNtTransfer.onTimeTickUpEvent(DownloadNotiTimesHelper.Event.EVERY_TIME_SHOW_NOTIFY );

            }else if(Objects.equals(from_action, "launchapp")){
                DownloadNtTransfer.onTimeTickUpEvent(DownloadNotiTimesHelper.Event.LAUNCH_APP );
    ...
    public static Notification createOngoingNotification(String channelName) {
        ...
        NotificationManager manager = (NotificationManager) DownloadManager.mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        if (VERSION.SDK_INT >= 26) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(DownloadManager.mContext, CHANNEL_ID1);
        RemoteViews remoteView = DownloadNtFgHelper.ongoingRemoteView();
        RemoteViews remoteViewBig = DownloadNtFgHelper.ongoingRemoteViewBig();
        ...
        Notification notification = builder
                ...
                .setSmallIcon(R.drawable.download_logo)
                .setShowWhen(true)
                .setOngoing(true)
                .setSound((Uri) null)
                /*.setNumber(5)*/
        ...
        FirebaseUtils.INSTANCE.setAnalyticsEvent("noti_touch_online", "", DownloadManager.mContext);
        return notification;
    }
}
