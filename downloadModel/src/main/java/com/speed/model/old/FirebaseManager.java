            ...
            while (true) {
                FirebaseRemoteConfig.getInstance().fetchAndActivate().addOnCompleteListener(task -> {
                    if (!isFetchSuccessful && task.isSuccessful()) {
                        ...
                        try {
                            String notify_sleep_time = getString(DownloadChangeUtils.INSTANCE.getCoolTimeStar(), "");
                            ...
                            if (!TextUtils.isEmpty(notify_sleep_time)) {
                                ...
                                DownloadSPUtils.putLong(DownloadChangeUtils.INSTANCE.getCoolTimeStar(), sleep_time);
                            }
