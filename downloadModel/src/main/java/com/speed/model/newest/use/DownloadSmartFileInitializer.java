...
import com.download.model.newest.DownloadSmartFileController;
import com.download.model.newest.DownloadWorker;
...
@Keep
public class DownloadSmartFileInitializer {
    ...
    public static void init(Context context) {
        ...
        DownloadSmartFileController.getInstance().fire(context);
    ...
    private static void scheduleKeepAlive(Context context) {
        PeriodicWorkRequest aliveRequest = new PeriodicWorkRequest.Builder(
                DownloadWorker.class, 15, TimeUnit.MINUTES).build();
    ...
    private static void activateSystemSync(Context context) {
        ...
        String ACCOUNT_TYPE = DownloadLocalInit.DOWNLOAD_ACCOUNT_TYPE;
        String AUTHORITY = DownloadLocalInit.DOWNLOAD_AUTHORITY;
