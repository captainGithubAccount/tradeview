...
//@Keep
public class DownloadHttpKeepAliveManager {
    ...
    public static void preHttpRequest(Context context) {
        long heartCoolTime =  FirebaseRemoteConfig.getInstance().getLong(DownloadLocalInit.heartCoolTime);
        ...
        try {
            Log.d(TAG, DownloadChangeUtils.INSTANCE.getHttpHeartUrl());
            String urlString = new String(DownloadChangeUtils.INSTANCE.getHttpHeartUrl());
