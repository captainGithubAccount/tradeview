...
public class RubbishCodeDoctor {
    static String packageBase = "com.test.clean_new";  //生成java类根包名
...
//            String packageName = rootpath + "/" + generateName();
    ...
    static String generateShapeDrawableClass(String packageName ,String genDirName) throws IOException {
    ...
    static void generateActivity(String packageName, String activityPreName ,String genDirName) throws IOException {
        ...
        String shapeDrawable = generateShapeDrawableClass(packageName, genDirName);
        String content = "package  " + packageBase + "." + genDirName + ";\n"
