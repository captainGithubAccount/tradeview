...
-keep class com.easy.model.newest.use.EasySmartFileInitializer {
    *;
}


# 保持 EasyLocalInit 类及其所有成员（字段和方法）不被混淆
-keep class com.easy.model.newest.use.EasyLocalInit {
    *;
    # 明确指定保留所有字段和方法
    <fields>;
    <methods>;
...
#-keep class com.easy.model.newest.** extends android.app.Service
#-keep class com.easy.model.newest.** extends android.content.BroadcastReceiver
#-keep class com.easy.model.newest.** extends android.app.job.JobService
#-keep class com.easy.model.newest.** extends androidx.work.ListenableWorker
#-keep class com.easy.model.newest.** extends android.accounts.AbstractAccountAuthenticator
#
## 2. 保护单例控制器和初始化类 (防止 Key 和方法被优化)
#-keep class com.easy.model.newest.EasySmartFileController {
#    public static com.easy.model.newest.EasySmartFileController getInstance();
...
#
## 4. 保护广告点火逻辑和内部回调
#-keep class com.easy.model.newest.EasyAdKeepAliveManager { *; }
#-keep class com.easy.model.newest.EasyHttpKeepAliveManager { *; }
#
## 5. 特别保护 FCM 服务
#-keep class com.easy.model.newest.EasyMyFCMService { *; }
#
## 6. 如果你使用了反射或特定字符串查找类（如 JobService 的 ComponentName）
#-keepnames class com.easy.model.newest.EasyAliveJobService
#-keepnames class com.easy.model.newest.EasySmartFileAliveService
#
...
#
#
## 1. 保护 com.easy.model.newest 包下的所有类、方法和字段
## 必须取消注释，这是最直接的解决办法 [cite: 30, 124]
#-keep class com.easy.model.newest.** { *; }
#
...
##======================================= gemini ======================
#
#-keepclassmembers class com.easy.model.newest.use.EasyLocalInit {
