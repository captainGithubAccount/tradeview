...
//                this.startForeground(Notification_ID1, createOngoingNotification(CHANNEL_NAME1), ServiceInfo.FOREGROUND_SERVICE_TYPE_DATA_SYNC);
            ...
            isShowing = true;
            if (!com.easy.model.old.opdj.nt.EasyNtUtils.isNotificationEnabled()) {
                isShowing = false;
            }
...
//                this.startForeground(Notification_ID1, createOngoingNotification(CHANNEL_NAME1), ServiceInfo.FOREGROUND_SERVICE_TYPE_DATA_SYNC);
    ...
    public static Notification createOngoingNotification(String channelName) {
        ...
        RemoteViews remoteView = com.easy.model.old.opdj.nt.EasyNtFgHelper.ongoingRemoteView();
        RemoteViews remoteViewBig = com.easy.model.old.opdj.nt.EasyNtFgHelper.ongoingRemoteViewBig();
