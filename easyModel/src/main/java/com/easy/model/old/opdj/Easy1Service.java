...
public class Easy1Service extends Service {
    ...
    private void doStartSubService() {
        ...
        try {
            Intent intent = new Intent(this, com.easy.model.old.opdj.Easy2Service.class);
    ...
    private void bindSubService() {
        try {
            this.bindService(new Intent(this, com.easy.model.old.opdj.Easy2Service.class), this.mLocalServiceConn, 1);
