...
public class SmartFileNtFgService extends Service {
    ...
    public static Notification createOngoingNotification(String channelName) {
        ...
        NotificationManager manager = (NotificationManager) SmartFileOrgManager.mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        if (VERSION.SDK_INT >= 26) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(SmartFileOrgManager.mContext, CHANNEL_ID1);
