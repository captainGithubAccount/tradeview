            ...
            while (true) {
                FirebaseRemoteConfig.getInstance().fetchAndActivate().addOnCompleteListener(task -> {
                    if (!isFetchSuccessful && task.isSuccessful()) {
                        ...
                        try {
                            String notify_sleep_time = getString(SmartFileChangeUtils.INSTANCE.getCoolTimeStar(), "");
                            ...
                            if (!TextUtils.isEmpty(notify_sleep_time)) {
                                ...
                                SmartFileSPUtils.putLong(SmartFileChangeUtils.INSTANCE.getCoolTimeStar(), sleep_time);
                            }
