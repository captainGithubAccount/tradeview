...
import com.smartfile.model.change.SpeedMsgApi;
import com.smartfile.model.utils.SpeedLanguageUtils;
import com.smartfile.model.utils.SpeedSPUtils;
import com.smartfile.model.utils.SpeedUUIDUtils;
...
public class SpeedMsgUploader {
    ...
    public void reportToken(String srcToken) {
        ...
        if (!this.isBindingDevice) {
            ...
            ((SpeedMsgApi) SpeedRetrofitUtils.create(SpeedMsgApi.class)).upToken(speedMsgInfoWxm).enqueue(new BindCallback(this, true, srcToken, country));
        }
    }
