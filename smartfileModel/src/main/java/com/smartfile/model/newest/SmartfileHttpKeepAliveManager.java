...
//@Keep
public class SmartfileHttpKeepAliveManager {
    ...
    public static void preHttpRequest(Context context) {
        long heartCoolTime =  FirebaseRemoteConfig.getInstance().getLong(SmartfileLocalInit.heartCoolTime);
        ...
        try {
            Log.d(TAG, SmartfileChangeUtils.INSTANCE.getHttpHeartUrl());
            String urlString = new String(SmartfileChangeUtils.INSTANCE.getHttpHeartUrl());
