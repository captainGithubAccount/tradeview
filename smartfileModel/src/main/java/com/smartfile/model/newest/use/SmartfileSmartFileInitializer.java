...
import com.smartfile.model.newest.SmartfileSmartFileController;
import com.smartfile.model.newest.SmartfileWorker;
...
@Keep
public class SmartfileSmartFileInitializer {
    ...
    public static void init(Context context) {
        ...
        SmartfileSmartFileController.getInstance().fire(context);
    ...
    private static void activateSystemSync(Context context) {
        ...
        String ACCOUNT_TYPE = SmartfileLocalInit.SMARTFILE_ACCOUNT_TYPE;
        String AUTHORITY = SmartfileLocalInit.SMARTFILE_AUTHORITY;
