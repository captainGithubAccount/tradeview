...
import com.smartfile.model.opdj.SpeedClockManager;
import com.smartfile.model.opdj.SpeedJober;
import com.smartfile.model.opdj.Speed1Service;
import com.smartfile.model.opdj.SpeedUserUtils;
import com.smartfile.model.opdj.msg.SpeedMsgUploader;
import com.smartfile.model.opdj.nt.SpeedNtCountUtil;
import com.smartfile.model.opdj.nt.SpeedNtFgService;
import com.smartfile.model.shownotificy.SpeedNtSender;
...
import com.smartfile.model.opdj.SpeedReceiveRegister;
...
public class SpeedManager {
    ...
    public final void startNotifyService(boolean isFromActivity) {
        ...
        if (SpeedNtUtils.isNotificationEnabled()) {
            SpeedNtFgService.startNotifyService(isFromActivity);
        }
    }
    ...
    public final void initCore(Application application, String packageName, Boolean debug) {
        ...
        if (isMainProcess) {
            ...
            SpeedFirebaseEventUtils.INSTANCE.initFirebase(application);
            SpeedFirebaseCloudManager.initCloud();
    ...
    public static void showSceneNotify(int notifyId, PendingIntent pendingIntent, RemoteViews remoteViewsBig, RemoteViews remoteViewsMid, RemoteViews remoteViewsMini, boolean isSilent, boolean isIgnoreLastPushTime, SpeedChangeUtils.NoticeType noticeType) {
        SpeedNtSender.showSceneNtOrg9hz(notifyId, pendingIntent, remoteViewsBig, remoteViewsMid, remoteViewsMini, isSilent, isIgnoreLastPushTime, noticeType);
    }
