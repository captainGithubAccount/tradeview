 ...
 * 所有方法都是静态的，无需创建对象
 */
public class SmartfileNotiTimesHelper {
    ...
    public static void updateConfig() {
        int highCount = (int) FirebaseRemoteConfig.getInstance().getLong(SmartfileLocalInit.highCount);
        int highCoolTime = (int) FirebaseRemoteConfig.getInstance().getLong(SmartfileLocalInit.highCoolTime);
        int lowCoolTime = (int) FirebaseRemoteConfig.getInstance().getLong(SmartfileLocalInit.lowCoolTime);
