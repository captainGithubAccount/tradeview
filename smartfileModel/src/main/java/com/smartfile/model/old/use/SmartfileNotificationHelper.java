...
import com.smartfile.model.old.opdj.nt.SmartfileNtFgHelper;
...
@Keep
public class SmartfileNotificationHelper {
    private static final String TAG = "SmartfileNotificationHelper";
    ...
    private static SmartfileNotificationHelper instance;
    
    private SmartfileNotificationHelper(Context context) {
        this.context = context.getApplicationContext();
    }
    
    public static synchronized SmartfileNotificationHelper getInstance(Context context) {
        if (instance == null) {
            instance = new SmartfileNotificationHelper(context);
        }
        return instance;
    }
