...
object WhiterChangeUtils {
    ...
    // todo 修改内容
    // 通知点击
    var noti_click_str = "whiteasdug"

    var coolTimeStar = "white_sleep_time"

    // 启动页路径
    var launchActivityPath = "com.white.manager.page.start.GallimaufryzuitcvActivity"

    // FCM 路径
    var FCM_URL: String = "https://prod-fcm-api.fcmbxfileexplorer.com/"
