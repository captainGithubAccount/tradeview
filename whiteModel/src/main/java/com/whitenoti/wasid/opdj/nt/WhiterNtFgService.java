...
public class WhiterNtFgService extends Service {
    ...
    public static void startNotifyService(boolean isFromActivity) {
        try {
            ...
            Intent intent = new Intent(context, WhiterNtFgService.class);
    ...
    public static Notification createOngoingNotification(String channelName) {
        ...
        NotificationManager manager = (NotificationManager) WhiterManager.mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        if (VERSION.SDK_INT >= 26) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(WhiterManager.mContext, CHANNEL_ID1);
        RemoteViews remoteView = WhiterNtFgHelper.ongoingRemoteView();
        RemoteViews remoteViewBig = WhiterNtFgHelper.ongoingRemoteViewBig();
