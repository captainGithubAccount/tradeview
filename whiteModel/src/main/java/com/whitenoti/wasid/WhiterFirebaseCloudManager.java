 ...
 * @author Admin
 */
public class WhiterFirebaseCloudManager {
            ...
            while (true) {
                FirebaseRemoteConfig.getInstance().fetchAndActivate().addOnCompleteListener(task -> {
                    if (!isFetchSuccessful && task.isSuccessful()) {
                        ...
                        try {
                            String notify_sleep_time = getString(WhiterChangeUtils.INSTANCE.getCoolTimeStar(), "");
                            ...
                            if (!TextUtils.isEmpty(notify_sleep_time)) {
                                ...
                                WhiterSPUtils.putLong(WhiterChangeUtils.INSTANCE.getCoolTimeStar(), sleep_time);
                            }
