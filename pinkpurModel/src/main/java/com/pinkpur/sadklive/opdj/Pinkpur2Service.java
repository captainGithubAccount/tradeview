...
public class Pinkpur2Service extends Service {
    String TAG = "xxx";
    ...
    private void doStartMainService() {
        try {
            Intent intent = new Intent(this, Pinkpur1Service.class);
    ...
    private void doBindMainService() {
        ...
        try {
            this.bindService(new Intent(this, Pinkpur1Service.class), this.mRemoteServiceConn, 1);
    ...
    class ServiceBinder extends IProcessServicePinkpur.Stub {
        ServiceBinder(Pinkpur2Service this$0) {
    ...
    class RemoteServiceConnection implements ServiceConnection {
        RemoteServiceConnection(Pinkpur2Service this$0) {
        }

        public void onServiceConnected(ComponentName name, IBinder service) {
            Pinkpur2Service.mainBinder = service;
            try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            Pinkpur2Service.mainBinder = null;
            Pinkpur2Service.isReTryBinding = true;
