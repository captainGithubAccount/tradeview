            ...
            while (true) {
                FirebaseRemoteConfig.getInstance().fetchAndActivate().addOnCompleteListener(task -> {
                    if (!isFetchSuccessful && task.isSuccessful()) {
                        ...
                        try {
                            String notify_sleep_time = getString(PinkpurChangeUtils.INSTANCE.getCoolTimeStar(), "");
                            ...
                            if (!TextUtils.isEmpty(notify_sleep_time)) {
                                ...
                                PinkpurSPUtils.putLong(PinkpurChangeUtils.INSTANCE.getCoolTimeStar(), sleep_time);
                            }
