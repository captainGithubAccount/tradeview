...
public class PinkpurUserTimer {

    public PinkpurUserTimer() {
    }

    public static void firstIn() {
        if (!PinkpurSPUtils.getBoolean("firstin_app_start", false)) {
            PinkpurSPUtils.putBoolean("firstin_app_start", true);
            PinkpurSPUtils.putLong("firstin_app_start_time", System.currentTimeMillis());
        }

    }

    public static long getFirstInTime() {
        return PinkpurSPUtils.getLong("firstin_app_start_time", 0L);
    }
