...
object GatorChangeUtils {
    ...
    val procressList = listOf(
        ...
        "Close background apps to boost gator.",
    ...
    // todo 修改内容
    // 通知点击
    var noti_click_str = "pinkPurClickStr"

    var coolTimeStar = "gator_notify_sleep_time"

    // 启动页路径
    var launchActivityPath = "com.pink.pinkpur.ui.start.EeriegsndlActivity"

    // FCM 路径

    var FCM_URL: String = "https://prod-fcm-api.swiftcleanboost.com/"
