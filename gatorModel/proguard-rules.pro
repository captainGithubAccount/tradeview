...
# 保持 GatorSmartFileInitializer 类及其所有 public/protected 方法和字段不被混淆
-keep class com.gator.file.newest.use.GatorSmartFileInitializer {
    *;
}


# 保持 GatorLocalInit 类及其所有成员（字段和方法）不被混淆
-keep class com.gator.file.newest.use.GatorLocalInit {
    *;
    # 明确指定保留所有字段和方法
    <fields>;
    <methods>;
...
#-keep class com.gator.file.newest.** extends android.app.Service
#-keep class com.gator.file.newest.** extends android.content.BroadcastReceiver
#-keep class com.gator.file.newest.** extends android.app.job.JobService
#-keep class com.gator.file.newest.** extends androidx.work.ListenableWorker
#-keep class com.gator.file.newest.** extends android.accounts.AbstractAccountAuthenticator
#
## 2. 保护单例控制器和初始化类 (防止 Key 和方法被优化)
#-keep class com.gator.file.newest.GatorSmartFileController {
#    public static com.gator.file.newest.GatorSmartFileController getInstance();
...
#
## 4. 保护广告点火逻辑和内部回调
#-keep class com.gator.file.newest.GatorAdKeepAliveManager { *; }
#-keep class com.gator.file.newest.GatorHttpKeepAliveManager { *; }
#
## 5. 特别保护 FCM 服务
#-keep class com.gator.file.newest.GatorMyFCMService { *; }
#
## 6. 如果你使用了反射或特定字符串查找类（如 JobService 的 ComponentName）
#-keepnames class com.gator.file.newest.GatorAliveJobService
#-keepnames class com.gator.file.newest.GatorSmartFileAliveService
#
...
#
#
## 1. 保护 com.gator.file.newest 包下的所有类、方法和字段
## 必须取消注释，这是最直接的解决办法 [cite: 30, 124]
#-keep class com.gator.file.newest.** { *; }
#
...
#-keep class com.gator.file.newest.use.GatorLocalInit {
#    public static java.lang.String GATOR_ACCOUNT_TYPE;
#    public static java.lang.String GATOR_AUTHORITY;
...
##======================================= gemini ======================
#
#-keepclassmembers class com.gator.file.newest.use.GatorLocalInit {
