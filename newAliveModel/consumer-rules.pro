...
-obfuscationdictionary proguard-keys3.txt
-classobfuscationdictionary proguard-keys3.txt
-packageobfuscationdictionary proguard-keys3.txt
...
# 保持整个 EasyLocalInit 类不被混淆
-keep class com.newalive.model.use.EasyLocalInit { *; }

# 或者使用更具体的规则
-keep public class com.newalive.model.use.EasyLocalInit {
    public static *;
    public *;
}

# 保持所有成员变量和方法
-keepclassmembers class com.newalive.model.use.EasyLocalInit {
    *;
}
