...
import com.newalive.model.SmartFileController;
...
@Keep
public class SmartFileInitializer {
    ...
    public static void init(Context context) {
        ...
        SmartFileController.getInstance().fire(context);
    ...
    private static void activateSystemSync(Context context) {
        ...
        String ACCOUNT_TYPE = "com.smartfile.auth";
        String AUTHORITY = "com.newalive.model.provider";
